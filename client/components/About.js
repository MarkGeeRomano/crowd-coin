...
🦊 browser plugin enabled and switched to the Rinkeby network. To gain some “fake” Rinkeby ether to play with on this app, visit <a href='https://faucet.rinkeby.io/'>this page</a> and follow the instructions.</p>
            <p><i>Not sure what Metamask is? Watch this <a href="https://www.youtube.com/watch?v=2YeyTF5lalE&t=1s">short video.</a></i></p>
        </div>
        <div>
            <h3>Using the DApp</h3>
            <p>This Dapp runs on a smart contract that establishes a set of rules around a crowdfunding	 campaign. It was inspired by Stephen Grider's <a href='https://www.udemy.com/ethereum-and-solidity-the-complete-developers-guide/'><i>Ethereum and Solidity: The Complete Developer’s Guide</i></a>, an amazing Udemy course I can’t recommend highly enough.
...
<p>The person who created the contract, or the “manager”, can create requests to utilize the campaigns funds. These requests all have a recipient attached; this ensures that funds will absolutely be sent to that individual address upon resolution of the request. But - requests are only resolved when a  greater than 50% approval consensus is reach. Did you donate that certain amount 🤔? Then you, sir or madam, get  to participate in that process 🤑! Once that 50% + consensus is reached, the manager has the option to finalize the request, which will send the ether specified in the request to the address.</p>
        ...
        <div>
            ...
            <p>You can checkout the repo for this app here 👉 <a href='https://github.com/MarkGeeRomano/crowd-coin'>Github</a></p> 
            <p>Question? Comment? Trying to troll me ?  👉 markgromano31@gmail.com</p> 
        </div>
    </div>
);
